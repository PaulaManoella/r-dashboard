...
#base discente
dataSource <- "avalia_2024.xlsx" 
baseDiscente <- read_excel(dataSource, sheet="D_DISC_2024-2") 

#base docente
baseDocente <- read_excel(dataSource, sheet="D_DOC_2024-2")
...
renderPlot({
  ...
  contagem <- lapply(data[, c("P111","P112","P113","P114","P115","P116","P117")], table)
  #37:43]
...
renderPlot({
  ...
  colunas <- as.character(111:117)
  mediasAvTurma <- colMeans(data[, colunas], na.rm=TRUE)
  
  print("medias av turma")
  print(mediasAvTurma)
  str(data[, colunas])
  ...
  mediasAvTurmaG <<- graficoMedia(df, df$medias, df$questoes, "Figura 12 – Médias dos itens relacionados à Avaliação da Turma")
...
renderPlot({
  ...
  cols21 <- as.character(211:214)
  cols22 <- as.character(221:228)
  cols23 <- as.character(231:234)
  
  media21 <- mean(unlist(data [, cols21]), na.rm=TRUE)
  media22 <- mean(unlist(data [, cols22]), na.rm=TRUE)
  media23 <- mean(unlist(data [, cols23]), na.rm=TRUE)
...
renderPlot({
  ...
  cols11 <- as.character(111:117)
  cols21 <- as.character(c(211:214, 221:228, 231:234))
  cols31 <- as.character(311:314)
  
  
  media11 <- mean(unlist(data [, cols11]), na.rm=TRUE)
  
  media21 <- mean(unlist(data [, cols21]), na.rm=TRUE)
  
  media31 <- mean(unlist(data [, cols31]), na.rm=TRUE)
...
renderPlot({
  ...
  colunas <- as.character(111:117)
  contagem11 <- lapply(data[, colunas], table)
...
renderPlot({
  ...
  contagem21 <- lapply(data [, as.character(211:214)], table)
  contagem22 <- lapply(data [, as.character(221:228)], table)
  contagem23 <- lapply(data [, as.character(231:234)], table)
...
renderPlot({
  ...
  contagemDisc <- lapply(data [, as.character(111:117)], table)
  contagemDoc <- lapply(data [, as.character(c(211:214, 221:228, 231:234))], table)
  contagemInfra <- lapply(data [, as.character(311:314)], table)
...
renderPlot({
  ...
  mediasDoc <- colMeans(data[, as.character(211:214)], na.rm=TRUE)
...
renderPlot({
  ...
  contagem <- lapply(data[, as.character(211:214)], table)
...
renderPlot({
  ...
  colunasTeste <<- c("P221","P222","P223","P224","P225","P226","P227","P228")
  
  mediasDiscente <- colMeans(data[, c("P221","P222","P223","P224","P225","P226","P227","P228")], na.rm=TRUE)
...
renderPlot({
  ...
  mediasDoc <- colMeans(data[, as.character(221:228)], na.rm=TRUE)
  print("mediasDoc")
  print(mediasDoc)
...
renderPlot({
  ...
  contagem <- lapply(data[, colunasTeste], table)
...
renderPlot({
  ...
  mediasDiscente <- colMeans(data[, c("P231","P232","P233","P234")], na.rm=TRUE)
...
renderPlot({
  ...
  mediasDoc <- colMeans(data[, as.character(231:234)], na.rm=TRUE)
...
renderPlot({
  ...
  mediasDiscente <- colMeans(data[, c("P311","P312","P313","P314")], na.rm=TRUE)
...
renderPlot({
  ...
  mediasDoc <- colMeans(data[, as.character(311:314)], na.rm=TRUE)
